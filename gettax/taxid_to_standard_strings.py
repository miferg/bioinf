...
try:
    ...
    print("""
Get taxonomy strings of standard ranks from ncbi taxon codes.
Input is a list of tax IDs, one per line, or multiple separated by dashes.
Last (or only) should be the most specific.
Needs the names.dmp and nodes.dmp downloaded from NCBI.
(https://ftp.ncbi.nlm.nih.gov/pub/taxonomy/taxdump.tar.gz)
Usage:
taxid_to_standard_strings.py names.dmp nodes.dmp INPUT OUTPUT_prefix
    """)
    sys.exit()
